...
- Using `openocd`:
  ...
  - If you get a "Can't find description for a cable named mimas_a7" error, download and save [this file](https://raw.githubusercontent.com/numato/samplecode/refs/heads/master/FPGA/MimasA7/openocd/numato_mimasa7.cfg) as `platform/mimasa7/numato_mimasa7.cfg`, re-run the `make` command, and program by running `openocd -f board/numato_mimasa7.cfg -c "init" -c "pld load 0 build/mimasa7.bit" -c "shutdown"` instead.
