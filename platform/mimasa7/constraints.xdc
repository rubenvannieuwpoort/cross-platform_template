...
#set_property -dict { PACKAGE_PIN "L3"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_clk_p}];                              # IO_L14P_T2_SRCC_35            Sch = HDMI_TX_CLK_P
#set_property -dict { PACKAGE_PIN "K3"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_clk_n}];                              # IO_L14N_T2_SRCC_35            Sch = HDMI_TX_CLK_N
...
#set_property -dict { PACKAGE_PIN "B1"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_r_p }];                            # IO_L1P_T0_AD4P_35             Sch = HDMI_TX0_P
#set_property -dict { PACKAGE_PIN "A1"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_r_n }];                            # IO_L1N_T0_AD4N_35             Sch = HDMI_TX0_N
#set_property -dict { PACKAGE_PIN "E1"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_g_p }];                            # IO_L3P_T0_DQS_AD5P_35         Sch = HDMI_TX1_P
#set_property -dict { PACKAGE_PIN "D1"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_g_n }];                            # IO_L3N_T0_DQS_AD5N_35         Sch = HDMI_TX1_N
#set_property -dict { PACKAGE_PIN "G1"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_b_p }];                            # IO_L5P_T0_AD13P_35            Sch = HDMI_TX2_P
#set_property -dict { PACKAGE_PIN "F1"    IOSTANDARD TMDS_33  }  [get_ports { hdmi_b_n }];                            # IO_L5N_T0_AD13N_35            Sch = HDMI_TX2_N
